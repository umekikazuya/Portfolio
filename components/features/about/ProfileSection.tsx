...
const certifications = [
  ...
  {
    title: "アクイア認定バックエンドスペシャリスト取得",
    date: "2023年11月",
    issuer: "アクイア",
    description: "",
  },
  {
    title: "Acquia Triple Certified Drupal Expert 受賞",
    date: "2023年11月",
    issuer: "アクイア",
    description: "",
  },
  {
    title: "GCP Associate Cloud Engineer取得",
    date: "2025年6月",
    issuer: "Google Cloud",
    description: "",
  },
            ...
            {Object.entries(skills).map(([category, items], categoryIndex) => (
              <SkillCategory key={category}>
                ...
                <SkillTags>
                  {items
                    .filter(
                      (skill) => profile.skill && profile.skill.includes(skill)
                    )
